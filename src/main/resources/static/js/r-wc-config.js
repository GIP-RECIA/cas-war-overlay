 ...
 */
const T = globalThis, I = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, j = Symbol(), W = /* @__PURE__ */ new WeakMap();
let et = class {
  constructor(t, e, s) {
...
const ot = (r) => new et(typeof r == "string" ? r : r + "", void 0, j), Ut = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: at, defineProperty: lt, getOwnPropertyDescriptor: ct, getOwnPropertyNames: dt, getOwnPropertySymbols: pt, getPrototypeOf: ut } = Object, f = globalThis, J = f.trustedTypes, $t = J ? J.emptyScript : "", k = f.reactiveElementPolyfillSupport, b = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? $t : null;
      break;
  ...
  return e;
} }, B = (r, t) => !at(r, t), K = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: B };
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, rt = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), xt = At(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function nt(r, t) {
...
const mt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    o += n === S ? h + _t : l >= 0 ? (s.push(c), h.slice(0, l) + st + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
...
class x {
  ...
  $(t) {
    ...
    if (((o = this._$AH) == null ? void 0 : o._$AD) === i) this._$AH.p(e);
      ...
      const n = new gt(i, this), a = n.u(this.options);
...
//# sourceMappingURL=r-wc-config.js.map
