...
public class PersonDirectoryPrincipalResolver implements PrincipalResolver {
    ...
    protected Map<String, List<Object>> retrievePersonAttributes(final String principalId,
        ...
        // Customization : do not inquire attribute repo if we know it is not needed (local auth and profile selection)
        if(repositoryIds.isEmpty()){
            LOGGER.debug("No attribute repository resolved, attributeFetcher will not be inquired");
