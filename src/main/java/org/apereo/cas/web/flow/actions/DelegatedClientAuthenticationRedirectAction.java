...
public class DelegatedClientAuthenticationRedirectAction extends BaseCasWebflowAction {
    ...
    protected Event doExecuteInternal(final RequestContext requestContext) throws Throwable {
        ...
        if (action instanceof WithLocationAction) {
            ...
            handleIdentityProviderWithExternalRedirect(requestContext, client, action, ticket);
        }
    ...
    protected void handleIdentityProviderWithExternalRedirect(final RequestContext requestContext,
        ...
        LOGGER.debug("Redirecting to [{}] via client [{}]", url.toString(), client.getName());
        requestContext.getExternalContext().requestExternalRedirect(url.toString());
    }
