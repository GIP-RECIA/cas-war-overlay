...
public class PrincipalProvisionerAction extends BaseCasWebflowAction {
    ...
    protected boolean provision(final RequestContext requestContext) {
        ...
        if(registeredService != null){
            if(registeredService.getProperties().containsKey("scimEnabled") && registeredService.getProperties().get("scimEnabled").getBooleanValue()){
        ...
        LOGGER.trace("No provisioning is necessary for registered service [{}]", registeredService);
        return true;
    }
}
