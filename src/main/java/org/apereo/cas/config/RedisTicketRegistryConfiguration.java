...
public class RedisTicketRegistryConfiguration {
    ...
    public static class RedisTicketRegistryCoreConfiguration {
        ...
        @Bean
        @RefreshScope(proxyMode = ScopedProxyMode.DEFAULT)
        @ConditionalOnMissingBean(name = "redisMappingContext")
        ...
        public TicketRegistry ticketRegistry(
            ...
            final ConfigurableApplicationContext applicationContext,
            final RedisMappingContext redisMappingContext,
            final CasConfigurationProperties casProperties) {
            return BeanSupplier.of(TicketRegistry.class)
                ...
                .supply(Unchecked.supplier(() -> {
                    ...
                    return new RedisTicketRegistry(cipher, ticketSerializationManager, ticketCatalog,
                        ...
                        searchCommands, redisKeyGeneratorFactory, redisMappingContext, casProperties);
                }))
