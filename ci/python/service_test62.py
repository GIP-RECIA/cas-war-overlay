...
from constants import CAS_BASE_URL, SERVICE_CERBERE_URL
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        if "cerbere" in self.path:
            ...
            validate_ticket_to_cas_and_return_attributes(self, SERVICE_CERBERE_URL, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8062):
    server_address = ('', port)
