...
CLIENT_ID = "client3-testcas"
CLIENT_SECRET = "secret3-testcas"
PROVIDER_METADATA_URL = "https://localhost:8443/cas/oidc/.well-known"
CLIENT_CALLBACK_URL = "http://localhost:8021/oidc/authorize"
SCOPES = "openid"

# Initialisation de l'app flask
app = Flask(__name__)
app.secret_key = "7f2d013e-1bfe-4a7a-9734-b40f57er78fa"
