...
from constants import CAS_BASE_URL, SERVICE_DELEGATION_CAS_REDIRECT_URL
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        validate_ticket_to_cas(self, SERVICE_DELEGATION_CAS_REDIRECT_URL, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8028):
    server_address = ('', port)
