...
from constants import CAS_BASE_URL, SERVICE_DELEGATION_SAML_1
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        validate_ticket_to_cas_and_return_attributes(self, SERVICE_DELEGATION_SAML_1, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8037):
    server_address = ('', port)
