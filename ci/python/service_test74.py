...
from constants import CAS_BASE_URL, SERVICE_CERBERE_URL_CHARTER_SIGNATED_MULTIDOMAIN
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        validate_ticket_to_cas_and_return_attributes(self, SERVICE_CERBERE_URL_CHARTER_SIGNATED_MULTIDOMAIN, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8074):
    server_address = ('', port)
