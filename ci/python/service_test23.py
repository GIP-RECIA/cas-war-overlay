...
from constants import CAS_BASE_URL, SERVICE_EXTERNALID_ATTRIBUTE_RELEASE_URL
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        validate_ticket_to_cas_and_return_attributes(self, SERVICE_EXTERNALID_ATTRIBUTE_RELEASE_URL, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8023):
    server_address = ('', port)
