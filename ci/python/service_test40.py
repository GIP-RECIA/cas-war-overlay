...
from constants import CAS_BASE_URL, SERVICE_REDIRECT_DELEGATION_PROFILE_SELECTION_URL
...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        validate_ticket_to_cas(self, SERVICE_REDIRECT_DELEGATION_PROFILE_SELECTION_URL, CAS_BASE_URL)

def run(server_class=HTTPServer, handler_class=RequestHandler, port=8040):
    server_address = ('', port)
