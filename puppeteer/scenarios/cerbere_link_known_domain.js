...
(async () => {
    ...
    try {
        ...
        const service = "http://localhost:8055/test"
        ...
        assert(pageContent.includes('<a href="http://localhost:8055/cerbere2/stylesheets/perdu.xhtml" id="password-forgotten">'))
        assert(pageContent.includes('<a href="http://localhost:8055/cerbere2/"'))
