...
(async () => {
    ...
    try {
        ...
        const service = "http://localhost:8032"

        // Login to cas
        await cas.goToPageAndEnterLocalCredentials(page, service+"/oidc/protected", "test1", "test")
        ...
        assert(pageContent.includes("\"sub\":\"00000000-0000-0000-0000-000000000006\""))
