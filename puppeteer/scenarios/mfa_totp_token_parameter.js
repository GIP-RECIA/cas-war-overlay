...
(async () => {
    ...
    try {
        ...
        const service = "http://localhost:8051/test"
        const additionalParam = "&token=aaaaa"

        // Login to cas
        // TODO : Can't put simple password because of chromium password breach popup that prevent pupeteer to take the focus
        await cas.loginWith(page, casHost, service+additionalParam, "test1001", "WmI7MM4J1Qr76uv")
